...
def main(config):
    ...
    _, _, test_set = get_foldwise_split(0, 0, folds_count, imgs_masks_pairs,
                                        read_from_file=True, save_split_to_file=False)
    ...
    for model in models:
        ...
        while h + size_h <= img.shape[0]:
            ...
            while w + size_w <= img.shape[1]:
                ...
                result = model._model.predict(patch, verbose=0)[0, :, :, :]
